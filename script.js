    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "IKMA ISRAEL KRAV MAGA ARBIV SYSTEM משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '12bf4b7f-4256-4d25-87b8-3105278330c9',
                    name: data.name || '',
                    email: data.email || '',
